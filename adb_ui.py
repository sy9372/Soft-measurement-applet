...
class adbui(QMainWindow):
    ...
    def setupUi(self, Form):
        ...
        self.input_numBox.setGeometry(QtCore.QRect(170, 70, 70, 22))
        self.input_numBox.setObjectName("input_numBox")

        self.output_numBox_2 = QtWidgets.QSpinBox(Form)
        self.output_numBox_2.setGeometry(QtCore.QRect(170, 100, 70, 22))
        ...
        self.label_14.setGeometry(QtCore.QRect(300, 552, 191, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPixelSize(15)
        font.setBold(True)
        ...
        self.label.setGeometry(QtCore.QRect(305, 5, 170, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.label_7.setGeometry(QtCore.QRect(85, 130, 60, 21))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPixelSize(16)
        font.setBold(True)
    ...
    def select3(self):
        ...
        if not os.path.exists(path1):
            os.makedirs(path1)
        filenames = name3 + '+adb' + t
        l.sys.stdout = l.Logger(path1+f'./{filenames}.txt')
        print(f"输入个数：{self.input_numBox.value()}")
        print(f"输出个数：{self.output_numBox_2.value()}")
        print(f"学习率：{self.iter_lineEdit.text()}")
        print(f"估计器最大数量：{self.iter_lineEdit_2.text()}")
        a, b, score = ADBS(self.fileName1, float(self.iter_lineEdit.text()), int(self.iter_lineEdit_2.text()))
        self.mx_lineEdit.setText(str(a))
        self.r_lineEdit_2.setText(str(b))
        self.score_lineEdit_3.setText(str(int(score)))
        img = Image.open("picture/adb_figure.png")
        img.resize((427, 320))
        self.picture.setPixmap(QtGui.QPixmap("picture/adb_figure.png"))
        self.picture.setScaledContents(True)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "AdaBoost"))
        ...
        self.label_13.setText(_translate("Form", "估计器最大数量："))
        ...
        self.label.setText(_translate("Form", "  AdaBoost算法"))
