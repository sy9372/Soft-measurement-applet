...
class gbdtui(QMainWindow):
    ...
    def setupUi(self, widget):
        ...
        self.label.setGeometry(QtCore.QRect(315, 1, 141, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.label_8.setGeometry(QtCore.QRect(275, 120, 131, 21))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPixelSize(16)
        font.setBold(True)
        ...
        self.lr_doubleSpinBox_2.setGeometry(QtCore.QRect(160, 120, 51, 22))
        ...
        self.iter_lineEdit.setGeometry(QtCore.QRect(159, 150, 53, 21))
        ...
        self.label_14.setGeometry(QtCore.QRect(290, 553, 191, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPixelSize(15)
        font.setBold(True)
    ...
    def select3(self):
        ...
        a, b, score = GBDTS(self.fileName1, float(self.lr_doubleSpinBox_2.value()), int(self.max_numBox_5.value()), int(self.minl_numBox_3.value()), int(self.input_numBox_4.value()), int(self.iter_lineEdit.text()))
