...
class rfui(QMainWindow):
    ...
    def setupUi(self, Form):
        ...
        self.label_14.setGeometry(QtCore.QRect(270, 542, 191, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPixelSize(15)
        font.setBold(True)
    ...
    def select3(self):
        ...
        a, b, score = RFS(self.fileName1, int(self.iter_lineEdit.text()), int(self.max_numBox.value()), int(self.minl_numBox.value()), int(self.mins_numBox.value()))
        self.mx_lineEdit.setText(str(a))
        self.r_lineEdit_2.setText(str(b))
        self.score_lineEdit_3.setText(str(int(score)))
        img = Image.open("picture/rf_figure.png")
        img.resize((427, 320))
        self.picture.setPixmap(QtGui.QPixmap("picture/rf_figure.png"))
        self.picture.setScaledContents(True)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "RF"))
        ...
        self.label.setText(_translate("Form", "  RF算法"))
